...
SOCIALACCOUNT_PROVIDERS = {
    ...
    'pinterest': {
        ...
        'PINTEREST_URL2' : 'api.pinterest.com',
        'PINTEREST_VERSION': 'v5',
        'SCOPE': ['user_accounts:read,pins:write_secret,pins:write,pins:read_secret,pins:read,boards:write_secret,boards:write,boards:read_secret,boards:read,', 'read_users',],
    },
}
